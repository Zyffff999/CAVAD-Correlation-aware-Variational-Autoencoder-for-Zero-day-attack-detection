...
def create_dir_path_dict(dir_path, num=MAX_FILES_TO_PROCESS):
    ...
    if os.path.isfile(dir_path) and dir_path.endswith('.pcap'):
        ...
        dir_path = os.path.join(dir_path, "time")
        try:
            pcap_files = [
            ...
            for idx, (filename, file_path, file_size) in enumerate(pcap_files):
...
def main():
    ...
    db_name = 'IDS_2018'
    data_dir = r"D:\OOD_detect\data\IDS2018\raw_attack\new"
    client = None
    try:
        ...
        for fn in os.listdir(data_dir):
            ...
            collection_name = pcap_path.split('\\')[-1]
